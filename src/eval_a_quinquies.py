...
def main_run(args: argparse.Namespace) -> None:
    ...
    # ──────────────────────────────────────────────────────────────────────────
    # noinspection DuplicatedCode
    adversarial_classifier: WideResNet = WideResNet(10, mean=CIFAR10_MEAN, std=CIFAR10_STD)
    # noinspection DuplicatedCode
    load_model(adversarial_classifier, "../models/WRN_28_10_cifar10_09428.safetensors")
    adversarial_classifier.to(device).eval()

    # noinspection DuplicatedCode
    final_classifier: WideResNet = WideResNet(10, bn_momentum=0.01, mean=CIFAR10_MEAN, std=CIFAR10_STD)
