...
def main_run(args: argparse.Namespace) -> None:
    ...
    # ──────────────────────────────────────────────────────────────────────────
    # noinspection DuplicatedCode
    vanilla_classifier: WideResNet = WideResNet(100, mean=CIFAR100_MEAN, std=CIFAR100_STD)
    load_model(vanilla_classifier, "../models/cifar100_linf_wrn28-10_cutmix_ddpm.safetensors")
    # noinspection DuplicatedCode
